...
// 测试样例个数
int caseNum = 1;
const string CASE_FILE_PREFIX = R"(..\src\output\out)";
const string CASE_FILE_SUFFIX = ".txt";
const int capacity = 40;
const float MAX_SIMILARITY = 0.5;
...
void runSolution() {
    ...
    cout << "running time: " << (endTime - startTime) / 1000 << "s" << endl;
